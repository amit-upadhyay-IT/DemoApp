package krishikalyan.aupadhyay.myapp.widgets;
...
import krishikalyan.aupadhyay.myapp.BuildConfig;
...
public class TimeWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String ACTION_UPDATE_TIME = "krishikalyan.aupadhyay.myapp.UPDATE_TIME";
