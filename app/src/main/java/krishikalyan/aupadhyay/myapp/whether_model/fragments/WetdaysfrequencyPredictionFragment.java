 ...
 */
public class WetdaysfrequencyPredictionFragment extends Fragment {

    private RecyclerView theRecyclerView;
    private DatabaseReference mDatabase;


    public WetdaysfrequencyPredictionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_wetdaysfrequency_prediction, container, false);
    }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Rainfall_Model_Dataset, PredictionListViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Rainfall_Model_Dataset, PredictionListViewHolder>(
            ...
            protected void populateViewHolder(PredictionListViewHolder viewHolder, Rainfall_Model_Dataset model, final int position) {
                ...
                double wet_freq = model.getWet_Days_Frequency();
                viewHolder.second_line_prediction.setVisibility(View.VISIBLE);
                viewHolder.second_line_prediction.setText("Wet Days Frequency : "+String.format("%.3f", wet_freq));
                ...
                viewHolder.item_detail_prediction.setText(String.format("%.3f", wet_freq));
