 ...
 */
public class EvatranspirationPredictionFragment extends Fragment {

    private RecyclerView theRecyclerView;
    private DatabaseReference mDatabase;

    public EvatranspirationPredictionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_evatranspiration_prediction, container, false);
    }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Rainfall_Model_Dataset, PredictionListViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Rainfall_Model_Dataset, PredictionListViewHolder>(
            ...
            protected void populateViewHolder(PredictionListViewHolder viewHolder, Rainfall_Model_Dataset model, final int position) {
                ...
                double evatranspiration = model.getEvatranspiration();
                String val = String.valueOf(evatranspiration);
                viewHolder.second_line_prediction.setVisibility(View.VISIBLE);
                viewHolder.second_line_prediction.setText("Evatranspiration : "+val.substring(0, 4));


                viewHolder.image_prediction.setVisibility(View.VISIBLE);
                viewHolder.image_prediction.setBackgroundResource(R.drawable.ic_water_black_36dp);

                viewHolder.item_detail_prediction.setText(val.substring(0, 4));
