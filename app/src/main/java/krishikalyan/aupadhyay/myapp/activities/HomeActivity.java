        ...
        public boolean onNavigationItemSelected(MenuItem menuItem) {
            ...
            switch (id)
            {
                ...
                case R.id.crops_checking_nav:
                    startActivity(new Intent(HomeActivity.this, CameraActivityFarm.class));
                    break;
...
/*        int currentPage = viewPager.getCurrentItem();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.detect_cam_image) {
            Intent intent = new Intent(HomeActivity.this, CameraActivityFarm.class);
            startActivity(intent);
        }
    ...
    class ProvideCityNameTask extends GenericRequestTask2 {
        ...
        public ProvideCityNameTask(Context context, HomeActivity activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
