...
import krishikalyan.aupadhyay.myapp.navdrawer.core.FlowingView;
import krishikalyan.aupadhyay.myapp.tasks.GenericRequestTask;
...
public class MainActivity extends AppCompatActivity implements LocationListener, MyMenuFragment.AmitCallbackWhenDrawerOpens {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLeftDrawerLayout = (AmitStyleDrawer) findViewById(R.id.id_drawerlayout);


        FragmentManager fm = getSupportFragmentManager();
        myMenuFragment = (MyMenuFragment) fm.findFragmentById(R.id.id_container_menu);
        FlowingView mFlowingView = (FlowingView) findViewById(R.id.sv);
        if (myMenuFragment == null) {
            fm.beginTransaction().add(R.id.id_container_menu, myMenuFragment = new MyMenuFragment()).commit();
        }
        mLeftDrawerLayout.setFluidView(mFlowingView);
        mLeftDrawerLayout.setMenuFragment(myMenuFragment);
        ...
        public boolean onNavigationItemSelected(MenuItem menuItem) {
            ...
            switch (id)
            {
                ...
                case R.id.profile_nav:
                    ...
                    break;
                case R.id.crops_checking_nav:
                    startActivity(new Intent(MainActivity.this, CameraActivityFarm.class));
                    break;
                case R.id.menu_share:
                {
                    Intent intent = new Intent(Intent.ACTION_SEND);
                    intent.setType("text/plain");
                    intent.putExtra(android.content.Intent.EXTRA_SUBJECT,"Kisan Kalyan App");
                    intent.putExtra(android.content.Intent.EXTRA_TEXT, "https://play.google.com/store/apps/details?id=com.amitupadhyay.ait.approach&hl=en");

                    startActivity(Intent.createChooser(intent,"Share via"));
                }
                break;
                case R.id.crops_info_nav:
                    Toast.makeText(MainActivity.this, "AIT Pune", Toast.LENGTH_SHORT).show();
                    break;
            }
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("SunShine App");
        final WebView webView = new WebView(this);
        String about = "<p>AIT Hackathon android app</p>" +
        ...
        about = "<style media=\"screen\" type=\"text/css\">" +
                ...
                "</style>" +
                about;
        webView.setBackgroundColor(Color.parseColor("#6c78a300"));
