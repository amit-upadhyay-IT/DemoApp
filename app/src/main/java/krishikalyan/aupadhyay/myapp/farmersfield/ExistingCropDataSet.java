...
public class ExistingCropDataSet {

    private double max_germ_temp, max_ph, max_rainfall, max_rip_temp, min_germ_temp, min_ph, min_rainfall, min_rip_temp;
    private String name, planting_date;

    public ExistingCropDataSet(double max_germ_temp, double max_ph, double max_rainfall, double max_rip_temp, double min_germ_temp, double min_ph, double min_rainfall, double min_rip_temp, String name, String planting_date) {
