package krishikalyan.aupadhyay.myapp.navdrawer.core;
...
/**
 * Created by aupadhyay on 3/24/17.
 */

public class AmitStyleDrawer extends ViewGroup {
    ...
    public AmitStyleDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
